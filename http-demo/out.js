(() => {
  ...
  // http-url:https://cdn.jsdelivr.net/npm/vue/dist/vue.js
  var require_vue = __commonJS({
    "http-url:https://cdn.jsdelivr.net/npm/vue/dist/vue.js"(exports, module) {
      (function(global2, factory) {
        ...
        function normalizeScopedSlot(normalSlots, key, fn) {
          var normalized = function() {
            ...
            var vnode = res && res[0];
            return res && (!vnode || vnode.isComment && !isAsyncPlaceholder(vnode)) ? void 0 : res;
          };
          if (fn.proxy) {
  ...
  console.log(import_vue.default);
})();
/*!
 * Vue.js v2.6.13
